...
class DataContainer:
    ...
    def append(self, current_id, data_input, expected_output):
        self.current_ids = np.append(self.current_ids, current_id)
        self.data_inputs = np.append(self.data_inputs, data_input)
        self.expected_outputs = np.append(self.expected_outputs, expected_output)
