...
class BaseSaver(ABC):
    ...
    @abstractmethod
    def save_step(self, step: 'BaseStep', context: 'ExecutionContext', summary_id: str = None) -> 'BaseTransformer':
        """
    ...
    @abstractmethod
    def can_load(self, step: 'BaseStep', context: 'ExecutionContext', summary_id: str = None) -> bool:
        """
    ...
    @abstractmethod
    def load_step(self, step: 'BaseStep', context: 'ExecutionContext', summary_id: str = None) -> 'BaseTransformer':
        """
...
class _HasSavers(ABC):
    ...
    def save(self, context: ExecutionContext, summary_id=None, full_dump=False) -> 'BaseTransformer':
        """
    ...
    def load(self, context: ExecutionContext, summary_id=None, full_dump=False) -> 'BaseTransformer':
        """
...
class FullDumpLoader(Identity):
    ...
    def load(self, context: ExecutionContext, summary_id=None, full_dump=True) -> BaseTransformer:
        """
        Load the full dump of a pipeline step.

        :param context: execution context
        :param summary_id: summary id to load
...
class _WithContextStepSaver(BaseSaver):
    ...
    def load_step(self, step: 'StepWithContext', context: ExecutionContext, summary_id: str = None) -> 'StepWithContext':
        """
    ...
    def save_step(self, step: 'StepWithContext', context: ExecutionContext, summary_id: str = None) -> 'StepWithContext':
        """
    ...
    def can_load(self, step: 'StepWithContext', context: 'ExecutionContext', summary_id: str = None):
        return True
