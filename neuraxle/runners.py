...
class CheckpointPipelineRunner(BasePipelineRunner):
    ...
    def fit_transform_steps_left_to_do(self, data_inputs, expected_outputs,
                                       steps_left_to_do: NamedTupleList):
        """
    ...
    def transform_steps_left_to_do(self, data_inputs, steps_left_to_do: NamedTupleList):
        """
    ...
    def find_starting_step_and_data_inputs(self, steps_as_tuple: NamedTupleList, data_inputs,
    ...
    def create_checkpoint_names(self, steps_as_tuple: NamedTupleList):
        """
