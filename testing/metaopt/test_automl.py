...
from neuraxle.metaopt.auto_ml import InMemoryHyperparamsRepository, AutoML, RandomSearchHyperparameterSelectionStrategy, \
    HyperparamsJSONRepository, kfold_cross_validation_split, create_split_data_container_function
...
def test_automl_early_stopping_callback(tmpdir):
    ...
    auto_ml = AutoML(
        ...
        callbacks=[
            MetricCallback('mse', metric_function=average_kfold_scores(mean_squared_error),
